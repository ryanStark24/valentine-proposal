...
const pleaseText = document.getElementById(
  "pleaseText",
) as HTMLParagraphElement;
const questionCard = document.querySelector(".question-card") as HTMLDivElement;
const celebration = document.getElementById("celebration") as HTMLDivElement;

// Messages to display when trying to click No
const pleaseMessages: string[] = [
  "Please? 🥺",
  "Are you sure? 💔",
  "Think again! 💭",
  "Really? 😢",
...
noBtn.addEventListener("mouseover", (e: MouseEvent) => {
...
function showPleaseMessage(): void {
...
function displayRandomMeme(): void {
